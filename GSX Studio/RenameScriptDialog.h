...
namespace GSX_Studio {
	...
	/// <summary>
	/// Summary for RenameScriptDialog
	/// </summary>
	public ref class RenameScriptDialog : DevExpress::XtraEditors::XtraForm
	{
	public:
		RenameScriptDialog(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ScriptPath->Location = System::Drawing::Point(131, 12);
			...
			this->ScriptPath->Size = System::Drawing::Size(262, 20);
			...
			this->labelControl1->Location = System::Drawing::Point(12, 15);
			this->labelControl1->Name = L"labelControl1";
			this->labelControl1->Size = System::Drawing::Size(75, 16);
			this->labelControl1->TabIndex = 7;
			this->labelControl1->Text = L"Script Name:";
			// 
			// simpleButton1
			// 
			this->simpleButton1->Location = System::Drawing::Point(131, 38);
			this->simpleButton1->Name = L"simpleButton1";
			this->simpleButton1->Size = System::Drawing::Size(128, 32);
			this->simpleButton1->TabIndex = 8;
			this->simpleButton1->Text = L"Rename";
			this->simpleButton1->Click += gcnew System::EventHandler(this, &RenameScriptDialog::simpleButton1_Click);
			// 
			// simpleButton2
			// 
			this->simpleButton2->Location = System::Drawing::Point(265, 38);
			this->simpleButton2->Name = L"simpleButton2";
			this->simpleButton2->Size = System::Drawing::Size(128, 32);
			this->simpleButton2->TabIndex = 9;
			this->simpleButton2->Text = L"Cancel";
			this->simpleButton2->Click += gcnew System::EventHandler(this, &RenameScriptDialog::simpleButton2_Click);
			// 
			// RenameScriptDialog
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(408, 85);
			...
			this->Name = L"RenameScriptDialog";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Rename Script";
