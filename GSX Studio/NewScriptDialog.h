...
namespace GSX_Studio {
	...
	/// <summary>
	/// Summary for NewScriptDialog
	/// </summary>
	public ref class NewScriptDialog : DevExpress::XtraEditors::XtraForm
	{
	public:
		NewScriptDialog(void)
		{
			InitializeComponent();
			//
	...
	private:
	public: DevExpress::XtraRichEdit::RichEditControl^  Description;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Description = (gcnew DevExpress::XtraRichEdit::RichEditControl());
			...
			this->labelControl1->Size = System::Drawing::Size(56, 13);
			this->labelControl1->TabIndex = 0;
			this->labelControl1->Text = L"Script Path:";
			// 
			// Description
			// 
			this->Description->ActiveViewType = DevExpress::XtraRichEdit::RichEditViewType::Simple;
			this->Description->EnableToolTips = true;
			this->Description->Location = System::Drawing::Point(90, 38);
			this->Description->Name = L"Description";
			this->Description->Options->Bookmarks->AllowNameResolution = false;
			this->Description->Options->DocumentCapabilities->FloatingObjects = DevExpress::XtraRichEdit::DocumentCapability::Disabled;
			this->Description->Options->DocumentCapabilities->InlinePictures = DevExpress::XtraRichEdit::DocumentCapability::Disabled;
			this->Description->Size = System::Drawing::Size(276, 84);
			this->Description->TabIndex = 2;
			this->Description->Views->SimpleView->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(37)),
				static_cast<System::Int32>(static_cast<System::Byte>(37)), static_cast<System::Int32>(static_cast<System::Byte>(38)));
			this->Description->Views->SimpleView->Padding = System::Windows::Forms::Padding(4, 4, 4, 0);
			// 
			// simpleButton1
			// 
			this->simpleButton1->Location = System::Drawing::Point(233, 128);
			this->simpleButton1->Name = L"simpleButton1";
			this->simpleButton1->Size = System::Drawing::Size(133, 38);
			this->simpleButton1->TabIndex = 3;
			this->simpleButton1->Text = L"Create Script";
			this->simpleButton1->Click += gcnew System::EventHandler(this, &NewScriptDialog::simpleButton1_Click);
			// 
			// labelControl2
			// 
			this->labelControl2->Location = System::Drawing::Point(12, 38);
			this->labelControl2->Name = L"labelControl2";
			this->labelControl2->Size = System::Drawing::Size(57, 13);
			this->labelControl2->TabIndex = 4;
			this->labelControl2->Text = L"Description:";
			// 
			// ScriptPath
			// 
			this->ScriptPath->EditValue = L"maps\\mp\\gametypes\\_clientids.gsc";
			this->ScriptPath->Location = System::Drawing::Point(90, 9);
			...
			this->ScriptPath->Size = System::Drawing::Size(276, 20);
			...
			this->ClientSize = System::Drawing::Size(378, 178);
			...
			this->Name = L"NewScriptDialog";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"New Script";
